...
// Ambil parameter
$jenis_seminar = $_GET['jenis'] ?? 'proposal';
$search = $_GET['search'] ?? '';
$start_date = $_GET['start_date'] ?? '';
$end_date = $_GET['end_date'] ?? '';

// Query untuk data yang akan dicetak
$query = "
    SELECT 
        d.id_dosen,
...
$judul = "Rekap Tesis - " . strtoupper($jenis_seminar);
...
<body>
    ...
    <div class="print-info">
        <p><strong>Jenis Seminar:</strong> <?php echo strtoupper($jenis_seminar); ?></p>
    ...
    <script>
        // Fokus pada tombol print saat dokumen siap
