...
// Query untuk mengambil data ujian disertasi
$query = "SELECT * FROM ujian_disertasi $searchCondition LIMIT $start, $limit";
$result = $koneksi->query($query);

// Query untuk menghitung total data
$totalQuery = "SELECT COUNT(*) as total FROM ujian_disertasi $searchCondition";
$totalResult = $koneksi->query($totalQuery);
$totalData = $totalResult->fetch_assoc()['total'];
$totalPages = ceil($totalData / $limit);

// Ambil data tesis untuk dropdown (hanya id_prodi antara 9 dan 13)
$queryTesis = "SELECT t.id_tesis, t.judul 
               FROM tesis t
               LEFT JOIN prodi p ON t.id_prodi = p.id
               WHERE t.id_prodi BETWEEN 9 AND 13";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add'])) {
        ...
        $sql = "INSERT INTO ujian_disertasi (id_tesis, jenis_ujian, tanggal_ujian, id_dosen, peran_dosen) VALUES ('$id_tesis', '$jenis_ujian', '$tanggal_ujian', '$id_dosen', '$peran_dosen')";
        $koneksi->query($sql);
        ...
        $id_dosen = $_POST['id_dosen'];
        $peran_dosen = $_POST['peran_dosen'];
        $sql = "UPDATE ujian_disertasi SET id_tesis='$id_tesis', jenis_ujian='$jenis_ujian', tanggal_ujian='$tanggal_ujian', id_dosen='$id_dosen', peran_dosen='$peran_dosen' WHERE id_ujian=$id_ujian";
        $koneksi->query($sql);
    } elseif (isset($_POST['delete'])) {
        $id_ujian = $_POST['id_ujian'];
        $sql = "DELETE FROM ujian_disertasi WHERE id_ujian=$id_ujian";
        $koneksi->query($sql);
    }
    header("Location: crud_disertasi.php");
    exit();
}
?>
...
<head>
    ...
    <title>CRUD Ujian Disertasi</title>
...
<body>
    ...
    <main class="content">
        <div class="container">
            <h2>Data Ujian Disertasi</h2>

            <!-- Form Pencarian dan Tombol Tambah Data -->
            <div class="search-and-add">
                <form method="GET" action="crud_disertasi.php" class="search-form">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="crud_disertasi.php" style="display:inline;">
        ...
        <div id="modal" class="modal">
            <div class="modal-content">
                ...
                <form method="POST" action="crud_disertasi.php">
                    ...
                    <div class="form-group">
                        ...
                        <select name="peran_dosen" id="modalPeranDosen" required>
                            ...
                            <option value="copromotor">Copromotor</option>
                            <option value="penguji_utama">Penguji Utama</option>
                            <option value="sekretaris_penguji">Sekretaris/Penguji</option>
                            <option value="penguji_1">Penguji 1</option>
                            <option value="penguji_2">Penguji 2</option>
                            <option value="penguji_3">Penguji 3</option>
                            <option value="penguji_4">Penguji 4</option>
                        </select>
                    </div>
    ...
    <script>
        ...
        function openAddModal() {
            ...
            // Reset semua dropdown ke opsi pertama (default)
            document.getElementById('modalIdTesis').selectedIndex = 0; // Reset dropdown tesis
            document.getElementById('modalJenisUjian').selectedIndex = 0; // Reset dropdown jenis ujian
            document.getElementById('modalIdDosen').selectedIndex = 0; // Reset dropdown dosen
            document.getElementById('modalPeranDosen').selectedIndex = 0; // Reset dropdown peran dosen
